...
\begin{multicols}{2}
  ...
  \noindent \textcolor{red}{\textbf{2. volitelný předmět} (všechny třídy berou jeden; vybírá se na konci druháku na dva roky)}
    ...
    \item Aplikovaná matematika (4. A)
		\item S. z biologie
		\item S. z dějepisu
    \item S. z dějin umění (při dřívějším zvolení předmětu Dějiny umění)
		\item S. z deskriptivní geometrie (při
		      dřívějším zvolení předmětu Deskriptivní geometrie)
		\item S. z ekonomie (při dřívějším zvolení předmětu Ekonomie)
		\item S. z fyziky
		\item S. z chemie
		\item S. z informatiky (při dřívějším zvolení předmětu Informatika a programování)
		\item S. z matematiky
		\item S. z molekulární biologie (při dřívějším zvolení předmětu Molekulární biologie)
...
\end{itemize}
\podnadpis{MÁŠ PROBLÉM NEBO NÁVRH?}{red}
Chceš se s něčím anonymně svěřit? Ve čtvrtém podlaží u biologie je \textbf{schránka důvěry}, do které můžeš vhodit svoje psaní. Na dotazy, připomínky, stížnosti atd. pravděpodobně odpoví někdo z pedagogů (možná školní psycholožka, kterou taky máme).

\begin{minipage}{\linewidth}
  \begin{minipage}{.22\linewidth}
    \boxik{red}{
    \hspace*{-7pt}
    \includegraphics[width=1.29\linewidth]{qrkod.png}
    \vfill}
  \end{minipage}
  \hfill
