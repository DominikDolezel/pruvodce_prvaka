...
\begin{itemize}[leftmargin=10pt]
	\item \textcolor{red}{\textbf{X. A}} --  \textbf{matematicky zaměřená třída}, většina studentů/ek už jde z tzv. nižšího gymnázia na Příční ulici (prima až kvarta), na vyšším se k nim následně připojí pár dalších
...
tělocvik, ale každý si vybere \textbf{sport} podle svých preferencí. Výčet níže ber s rezervou
(může se cokoli změnit, některé předměty mohou přibýt nebo ubýt). V případě
nízkého zájmu se rovněž \textbf{některé předměty nebo sporty nemusejí otevřít}, ale v posledních
...
\columnbreak
  ...
  \begin{tcolorbox}[colback=red,boxrule=0pt, sharp corners]
    ...
    a~proto jim musí být uzpůsoben i~repertoár
    volitelných předmětů. Pokud se ti ale některý tobě nedostupný předmět vážně zalíbil,
...
Na začátku prvního ročníku každý/á student/ka dostane klíč od skříňky, kterou bude další čtyři roky sdílet se svým spolužákem/ačkou. Klíč se nevyplácí ztratit, protože potom musíš zařídit nový na vlastní náklady. Pokud si chceš ve skříňce nechávat víc věcí a nechceš je všechny prohrabávat, když něco hledáš, doporučujeme v Ikeji koupit \uv{úložný díl} (třeba Rassla), který se dá umístit na šatní tyč ve skříňce a udělá ti z ní hotové království poliček. Zároveň si tam dej svoje oblíbené papučky, protože \textbf{v celém prostoru školy je nutné se přezouvat}.

\podnadpis{MIMOŠKOLNÍ AKTIVITY}{red}
\begin{itemize}[leftmargin=10pt]
  \item \textbf{Studentský parlament} má na naší škole už dlouholetou tradici. Je to dobrovolná organizace studentů a studentek, co chtějí na škole něco změnit. Funguje jako primární orgán komunikace studentů/ek s vedením. Taky pořádáme různé akce a projekty -- třeba tematické dny nebo burzu učebnic. Parlament má na svědomí taky tohoto {\Kapitan Průvodce prváka}. Pro více informací si někoho z parlamentu odchytni (každá třída má zpravidla aspoň jednoho zástupce/kyni) nebo nás kontaktuj na instagramu \textit{@parlament\_jaroska}.
