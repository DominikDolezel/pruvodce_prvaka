...
\newcommand{\nadpis}[4]{
  \vspace*{-60pt}
  \begin{tcolorbox}[colback = #2, boxrule = 0pt, grow to left by = #4,  grow to right by = #4, arc=8pt]
    \vspace*{20pt}
...
\textcolor{white}{
  \nadpis{SEZNAM KABINETŮ}{white}{darkblue}{-3.1cm}
  ...
  \vfill
  \noindent\textcolor{white}{\textbf{Poznámka.} Jak sis mohl všimnout, na naší škole nemáme \textit{patra}, ale \textit{podlaží}. Ve zkratce: když vejdeš dveřmi z ulice, jsi v nultém patře (v přízemí -- tento přístup razí informatici), ale v 1. podlaží. \\
...
\begin{minipage}{0.35\linewidth}
	\centering
	\includegraphics[width=\linewidth]{vytah.png}
\end{minipage}
\vspace{0pt}\\
\noindent
...
\nadpis{FORMÁLNÍ ZÁLEŽITOSTI}{blue}{white}{-2.4cm}
...
\vfill
\begin{center}
	\includegraphics[width=0.95\linewidth]{absence.png}
\end{center}
...
\textcolor{white}{\Kapitan Průvodce prváka} tady bohužel není od toho, aby poskytnul vyčerpávající výčet takovýchhle situací. Pokud nebudeš něco vědět, \textbf{prostě zajdi za třídním}. Vždycky všecko vyřeší. Ne nadarmo jim říkáme matky / otcové třídní.
...
\noindent\includegraphics[width=1.18\linewidth]{mapa.png}
\restoregeometry
\pagebreak
