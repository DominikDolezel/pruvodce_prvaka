...
\begin{itemize}[leftmargin=10pt]
  \item \textbf{Studentský parlament} má na naší škole už dlouholetou tradici. Je to dobrovolná organizace studentů, kteří chtějí na škole něco změnit. Funguje jako primární orgán komunikace studentů s vedením. Taky pořádáme různé akce a projekty -- třeba tematické dny nebo burzu učebnic. Parlament má na svědomí taky tento {\Kapitan Průvodce prváka}. Pro více informací si někoho z parlamentu odchytni (každá třída má zpravidla aspoň jednoho zástupce/kyni) nebo nás kontaktuj na instagramu \href{https://www.instagram.com/parlament_jaroska/}{\texttt{@parlament\_jaroska}}.
...
\begin{itemize}[leftmargin=10pt]
  ...
  \item \textbf{Kamdu} -- Kamdu je prostor pro inspiraci a propojování mladých lidí, kteří chtějí rozšiřovat své obzory a hledají nové možnosti vzdělávání podle svého zájmu. Na praktických workshopech ve firmách a organizacích se mohou potkávat s předními odborníky-inspirátory a objevovat praxi různých oborů.
\end{itemize}
\podnadpis{MÁŠ PROBLÉM NEBO NÁVRH?}{red}
Chceš se s něčím svěřit? Ve čtvrtém patře u biologie je \textbf{schránka důvěry}, do které můžeš vhodit svoje psaní. Na dotazy, připomínky, stížnosti atd. pravděpodobně odpoví někdo z pedagogů (možná školní psycholožka, kterou taky máme).
...
\begin{minipage}{\linewidth}
  ...
  \begin{minipage}{.68\linewidth}
    \vspace*{-15pt}
    Pro přímou komunikaci se studentským parlamentem byla zřízena schrán\-ka studentských vzkazů, stížností a přání (\textbf{SSVSP}) kam můžeš napsat návrhy, který by se mohly projednávat na schůzi parlamentu. Pokud to bude v jeho silách, určitě s tím jeho členi a členky něco udělají! Najdeš ho jako QR kód tady nebo na nástěnce Parlamentu v přízemí. Odkaz ti pro jistotu napíšeme: \url{https://forms.gle/27KuUc22q8dVAHX96} (doporučujeme najít {\Kapitan Průvodce prváka} na webu školy a odkaz zkopírovat z e-verze).
  \end{minipage}
\end{minipage}
...
\noindent Jak si můžeš všimnout, není tady žádný rozdíl mezi nezletilým/ou a zletilým/ou studentem/kou -- oficiálně zletilé/mu studentovi/ce absence omlouvá pořád rodič.
%\vfill
\begin{center}
...
Když se třeba začneš angažovat v divadle, jiném umění, či sportu, pochopitelně to neznamená, že tě vyhodíme. Na stránkách školy najdeš \textbf{tři lejstra}, která musíš pro získání individuálního studijního plánu vyplnit a předat třídnímu učiteli/ce. Ten/ta to předá řediteli, který posoudí oprávněnost nároku.
