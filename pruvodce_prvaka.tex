...
\noindent V rámci možností (a našich osnov) jdeme s dobou -- \textbf{pro 3. a 4. ročník si tedy můžeš} (respektive musíš) \textbf{vybrat volitelné předměty}. V matematické třídě se z časových důvodů předmětů volí míň. Ve čtvrťáku už zároveň nemáme běžný tělocvik, ale každý si vybere \textbf{sport} podle svých preferencí. Výčet níže ber s rezervou
...
\columnbreak
    ...
    \item S. z dějin umění $\rightarrow$
		...
		\item S. z fyziky
		\item S. z chemie
		\item S. z informatiky $\rightarrow$
		\item S. z matematiky
...
\medskip
	\begin{tcolorbox}[colback=red,boxrule=0pt, sharp corners]
		\textcolor{white}{\footnotesize \textbf{Poznámky.}
			...
			uzpůsoben i repertoár volitelných předmětů. Pokud se ti ale některý tobě nedostupný předmět vážně zalíbil, zkus se domluvit s vedením -- jsme přece lidi. ☺︎\\
			Navíc, výčet nemusí být kompletní nebo naopak některé předměty můžeme zrušit. Neboj, vše se dozvíš včas!
      }
		\hfill
	\end{tcolorbox}
\end{multicols}
